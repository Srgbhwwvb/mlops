...
from src.data.preprocessing import create_train_transforms, create_val_transforms, create_test_transforms
...
class TestDataset:
    ...
    def test_dataset_without_transform(self, tmp_path):
        ...
        img, label = dataset[0]
        assert isinstance(img, Image.Image)  # Without transform, should return PIL Image
        assert isinstance(label, int)
    ...
    def test_dataset_test_mode(self, tmp_path):
        ...
        dataset = PlantDataset(str(dataset_dir / "*.png"), transform=None, is_train=False)
...
class TestDataLoaders:
    ...
    def test_create_data_loaders(self, mock_dataloader, mock_random_split, mock_dataset):
...
class TestPreprocessingEdgeCases:
    ...
    def test_preprocessing_string_values_handling(self):
        ...
        try:
            ...
            pytest.skip("String conversion should be handled at config validation level")
