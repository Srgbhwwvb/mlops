...
class TestConfigValidation:
    def test_valid_config(self):
        ...
        valid_config = {
            "data": {"train_path": "/path/to/train", "val_size": 0.2},
            "model": {"name": "resnet50", "num_classes": 12},
            "training": {"batch_size": 16, "epochs": 10, "learning_rate": 0.001},
            "transforms": {"image_size": 224},
            "output": {"model_dir": "./models"},
        }
    ...
    def test_invalid_config(self):
        ...
        invalid_config = {
            "data": {"val_size": 1.5}  # Invalid value
