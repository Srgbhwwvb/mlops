...
def predict_single_image(model_path, image_path, config_path="configs/train_config.yaml"):
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Predict plant class using PlantPredictor')
